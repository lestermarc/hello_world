--------------------------------------------------------
--  DDL for Package Body ACT_LIB_PAYMENT_ISO_1_1_3
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "ACT_LIB_PAYMENT_ISO_1_1_3" 
/**
...
begin
  ...
  select
    XMLElement("Document",
      XMLAttributes(
        'urn:iso:std:iso:20022:tech:xsd:pain.001.001.03' as "xmlns",
        'http://www.w3.org/2001/XMLSchema-instance' as "xmlns:xsi",
        'urn:iso:std:iso:20022:tech:xsd:pain.001.001.03 pain.001.001.03.xsd' as "xsi:schemaLocation"),
      XMLElement("CstmrCdtTrfInitn",
        act_lib_payment_ISO_1_1_3.group_header(
          act_mgt_payment_iso.count_creditors,
          act_mgt_payment_iso.total_amount_creditors),
        act_lib_payment_ISO_1_1_3.payment_info(id_execuction)
      )
    ) into lx_data
  from DUAL;
...
begin
  select
    XMLAgg(XMLElement("PmtInf",
      ...
      act_lib_payment_ISO_1_1_3.transactions(T.CURRENCY, T.PAYMENT_TYPE)
    )) into lx_data
