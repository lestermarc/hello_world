--------------------------------------------------------
--  DDL for Package Body ACT_LIB_PAYMENT_ISO_1_3_3_DE
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "ACT_LIB_PAYMENT_ISO_1_3_3_DE" 
/**
...
begin
  ...
  select
    XMLElement("Document",
      XMLAttributes(
        'urn:iso:std:iso:20022:tech:xsd:pain.001.003.03' as "xmlns",
        'http://www.w3.org/2001/XMLSchema-instance' as "xmlns:xsi",
        'urn:iso:std:iso:20022:tech:xsd:pain.001.003.03 pain.001.003.03.xsd' as "xsi:schemaLocation"),
...
begin
  select
    XMLAgg(XMLElement("PmtInf",
      ...
      transactions(T.CURRENCY, T.PAYMENT_TYPE)
    )) into lx_data
...
begin
  select
    XMLAgg(XMLElement("CdtTrfTxInf",
      ...
      XMLElement("CdtrAcct",
        XMLElement("Id",
            case when (T.C_TYPE_REFERENCE = '5') then
              XMLElement("IBAN", T.ACCOUNT_NUMBER)
            else
              /* Pas géré dans la norme allemande, mais ainsi, en cas d'utilisation d'un autre type de référence, le fichier est invalide */
              XMLElement("Othr",
...
END ACT_LIB_PAYMENT_ISO_1_3_3_DE;
