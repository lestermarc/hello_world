--------------------------------------------------------
--  DDL for Package Body DOC_EDI_EDEC_EXPOWIN_V405
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "DOC_EDI_EDEC_EXPOWIN_V405" 
as
  /**
  ...
  */
  ...
  begin
    ...
    DOC_EDI_EXPOWIN_FMT_V405.Write_Header(aExportJobID => vJobID, aItem => vHeader);
    -- Insertion des données d'export relatives aux éléments Position
    DOC_EDI_EXPOWIN_FMT_V405.Write_Positions(aExportJobID => vJobID, aList => vTblPositions);
    -- Insertion des données d'export relatives aux éléments Packing
    DOC_EDI_EXPOWIN_FMT_V405.Write_Packing(aExportJobID => vJobID, aList => vTblPacking);
  ...
  */
  ...
  begin
    ...
    if vHeaderNumber is not null then
      ...
      DOC_EDI_EDEC_EXPOWIN_V405.GenerateAddresses(aHeaderID => aHeaderID);
    end if;
