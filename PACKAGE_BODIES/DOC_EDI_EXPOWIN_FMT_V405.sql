--------------------------------------------------------
--  DDL for Package Body DOC_EDI_EXPOWIN_FMT_V405
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "DOC_EDI_EXPOWIN_FMT_V405" 
as
  /**
  ...
  */
  ...
  begin
    ...
    vResult  := /* offset =  574 */ vResult || DOC_EDI_EXPORT_JOB_FUNCTIONS.PcsRpad(' ', 40);
    ...
    vResult  := /* offset = 2141 */ vResult || DOC_EDI_EXPORT_JOB_FUNCTIONS.PcsRpad(' ', 40);
    vResult  :=   /* offset = 2181 */
    ...
    vResult  := /* offset = 7345 */ vResult || DOC_EDI_EXPORT_JOB_FUNCTIONS.PcsLpad(aItem.H1EUDEZOLLANTRAG, 'FM0', 1);
    vResult  := /* offset = 7346 */ vResult || DOC_EDI_EXPORT_JOB_FUNCTIONS.PcsRpad(aItem.H1_RE_EORI_NR, 17);
    vResult  := /* offset = 7363 */ vResult || DOC_EDI_EXPORT_JOB_FUNCTIONS.PcsRpad(aItem.H1_WE_EORI_NR, 17);
    vResult  := /* offset = 7380 */ vResult || DOC_EDI_EXPORT_JOB_FUNCTIONS.PcsRpad(aItem.H1_SP_EORI_NR, 17);
    return trim(vResult);
