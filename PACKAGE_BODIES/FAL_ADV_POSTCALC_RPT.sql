--------------------------------------------------------
--  DDL for Package Body FAL_ADV_POSTCALC_RPT
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "FAL_ADV_POSTCALC_RPT" 
is
  /**
   * procedure ADV_POSTCALC_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de post-calculation avancée
  ...
  end ADV_POSTCALC_RPT_PK;

  /**
   * procedure ADV_POSTCALC_OPTIONS_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de post-calculation avancée
  ...
  end ADV_POSTCALC_OPTIONS_RPT_PK;

  /**
   * procedure ADV_POSTCALC_CPTS_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de post-calculation avancée
  ...
  end ADV_POSTCALC_CPTS_RPT_PK;

  /**
   * procedure CPTSTASKS_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de post-calculation avancée
   *   Retourne la liste des composants (et leurs détails) liés au produit
   *   calculé, ainsi que les opérations qui y sont liées (et leurs détails).
   */
  procedure ADV_POSTCALC_CPTS_TASKS_RPT_PK(
    aRefCursor  in out CRYSTAL_CURSOR_TYPES.DualCursorTyp
  , PROCPARAM_0 in     FAL_ADV_CALC_OPTIONS.CAO_SESSION_ID%type
  , PROCPARAM_1 in     FAL_ADV_CALC_OPTIONS.FAL_ADV_CALC_OPTIONS_ID%type
  , PROCPARAM_2 in     FAL_ADV_CALC_GOOD.GCO_GOOD_ID%type
  ...
  end ADV_POSTCALC_CPTS_TASKS_RPT_PK;

  /**
   * procedure ADV_POSTCALC_WORK_RPT_PK
   * Description
   *   Procédure stockée utilisée pour les rapports de post-calculation avancée
  ...
  end ADV_POSTCALC_WORK_RPT_PK;

  /**
   * procedure ADV_POSTCALC_SUBCT_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de post-calculation avancée
  ...
  end ADV_POSTCALC_SUBCT_RPT_PK;

  /**
   * procedure ADV_POSTCALC_TASKS_RPT_PK
   * Description
   *   Procédure stockée utilisée pour les rapports de post-calculation avancée
  ...
  end ADV_POSTCALC_TASKS_RPT_PK;

  /**
   * procedure ADV_POSTCALC_PROD_RPT_PK
   * Description
   *   Procédure stockée utilisée pour les rapports de post-calculation avancée
  ...
  end ADV_POSTCALC_PROD_RPT_PK;
end FAL_ADV_POSTCALC_RPT;
