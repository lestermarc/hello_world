--------------------------------------------------------
--  DDL for Package Body FAL_ADV_WIPCALC_RPT
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "FAL_ADV_WIPCALC_RPT" 
is
  /**
   * procedure ADV_WIPCALC_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de calculation des en-cours avancée
  ...
  end ADV_WIPCALC_RPT_PK;

  /**
   * procedure ADV_WIPCALC_OPTIONS_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de calculation des en-cours avancée
  ...
  end ADV_WIPCALC_OPTIONS_RPT_PK;

  /**
   * procedure ADV_WIPCALC_CPTS_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de calculation des en-cours avancée
  ...
  end ADV_WIPCALC_CPTS_RPT_PK;

  /**
   * procedure ADV_WIPCALC_CPTS_TASKS_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de calculation des en-cours avancée
   *   Retourne la liste des composants (et leurs détails) liés au produit
  ...
  end ADV_WIPCALC_CPTS_TASKS_RPT_PK;

  /**
   * procedure ADV_WIPCALC_WORK_RPT_PK
   * Description
   *   Procédure stockée utilisée pour les rapports de calculation des en-cours avancée
  ...
  end ADV_WIPCALC_WORK_RPT_PK;

  /**
   * procedure ADV_WIPCALC_SUBCT_RPT_PK
   * Description
   *   Procédure stockée utilisée pour le rapport de calculation des en-cours avancée
   ...
   *   PROCPARAM_3.
   */
  procedure ADV_WIPCALC_TASKS_RPT_PK(
    aRefCursor  in out CRYSTAL_CURSOR_TYPES.DualCursorTyp
  , PROCPARAM_0 in     FAL_ADV_CALC_OPTIONS.CAO_SESSION_ID%type
  , PROCPARAM_1 in     FAL_ADV_CALC_OPTIONS.FAL_ADV_CALC_OPTIONS_ID%type
  , PROCPARAM_2 in     FAL_ADV_CALC_GOOD.GCO_GOOD_ID%type
  ...
  end ADV_WIPCALC_TASKS_RPT_PK;

  /**
   * procedure ADV_WIPCALC_PROD_RPT_PK
   * Description
   *   Procédure stockée utilisée pour les rapports de calculation des en-cours avancée
  ...
  end ADV_WIPCALC_PROD_RPT_PK;
end FAL_ADV_WIPCALC_RPT;
