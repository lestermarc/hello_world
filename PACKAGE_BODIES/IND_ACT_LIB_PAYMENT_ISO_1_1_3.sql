--------------------------------------------------------
--  DDL for Package Body IND_ACT_LIB_PAYMENT_ISO_1_1_3
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "IND_ACT_LIB_PAYMENT_ISO_1_1_3" 
/**
  ...
  select
    XMLElement("Document",
      ...
      XMLElement("CstmrCdtTrfInitn",
        IND_ACT_LIB_PAYMENT_ISO_1_1_3.group_header(
          act_mgt_payment_iso.count_creditors,
          act_mgt_payment_iso.total_amount_creditors),
        IND_ACT_LIB_PAYMENT_ISO_1_1_3.payment_info(id_execuction)
      )
    ) into lx_data
  from DUAL;
...
begin
  select
    XMLAgg(XMLElement("PmtInf",
      ...
      IND_ACT_LIB_PAYMENT_ISO_1_1_3.transactions(T.CURRENCY, T.PAYMENT_TYPE)
    )) into lx_data
...
END IND_ACT_LIB_PAYMENT_ISO_1_1_3;
