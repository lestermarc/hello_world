--------------------------------------------------------
--  DDL for Package Body VDOC_ACT_PRE_ENTRY_VALIDATION
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "VDOC_ACT_PRE_ENTRY_VALIDATION" 
IS
/**
...
*/
   ...
   *****************************************************************/
    ...
    *
    *
    * test it :  select vdoc_act_pre_entry_validation.get_sql_for_initialization('rrimbert') from dual;
    *
    *
    */
   ...
   BEGIN
      ...
      RETURN v_sql_stmt;
   END get_sql_for_initialization;
END vdoc_act_pre_entry_validation;
