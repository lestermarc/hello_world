--------------------------------------------------------
--  DDL for Procedure IND_C9_CERTIF_PERIOD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "IND_C9_CERTIF_PERIOD" (PROCPARAM0 varchar2,PROCPARAM1 varchar2,PROCPARAM2 varchar2,aRefCursor in out CRYSTAL_CURSOR_TYPES.DualCursorTyp)
