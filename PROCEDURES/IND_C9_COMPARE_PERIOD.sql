--------------------------------------------------------
--  DDL for Procedure IND_C9_COMPARE_PERIOD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "IND_C9_COMPARE_PERIOD" (PARAMETER_PROC0 varchar2, PARAMETER_PROC1 varchar2, PARAMETER_PROC2 varchar2, aRefCursor in out CRYSTAL_CURSOR_TYPES.DualCursorTyp)
